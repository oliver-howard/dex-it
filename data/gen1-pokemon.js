// Generation 1 Pokemon Database (Kanto Region)
// Pokemon #1-151: Bulbasaur to Mew
...
function getGen1PokemonById(id) {
    return GEN1_POKEMON.find(pokemon => pokemon.id === id);
}

// Helper function to get Pokemon by name
function getGen1PokemonByName(name) {
    return GEN1_POKEMON.find(pokemon => pokemon.name.toLowerCase() === name.toLowerCase());
}

// Helper function to get all Pokemon of a specific type
function getGen1PokemonByType(type) {
    return GEN1_POKEMON.filter(pokemon => pokemon.types.includes(type.toLowerCase()));
}
...
if (typeof module !== 'undefined' && module.exports) {
    module.exports = { 
        GEN1_POKEMON, 
        getGen1PokemonById, 
        getGen1PokemonByName, 
        getGen1PokemonByType 
    };
}
